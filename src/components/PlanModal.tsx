...
export const PlanModal: React.FC<PlanModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-2 sm:p-4 pb-20 md:pb-4 bg-black/50 backdrop-blur-sm overflow-y-auto overscroll-contain">
      {recurringProgress && (
      ...
      <div className="theme-surface rounded-3xl w-full max-w-lg max-h-[calc(100vh-6rem)] sm:max-h-[90vh] flex flex-col animate-in fade-in zoom-in-95 duration-200 my-2 sm:my-8 overflow-hidden">
