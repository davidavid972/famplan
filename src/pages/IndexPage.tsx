  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <motion.div
        ...
        dir={dir}
      >
        <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${isConnected ? 'bg-primary/10 text-primary' : 'bg-secondary'}`}>
          {isConnected ? <CheckCircle2 className="w-5 h-5" /> : (
